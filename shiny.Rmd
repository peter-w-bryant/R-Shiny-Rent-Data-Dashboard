...
ui <- fluidPage(
  ...
  mainPanel(
    ...
    conditionalPanel(condition = "input.map_var == 'Median Home Prices'", plotOutput("median_price_plot", width = "500px", height = "300px")),
...
server <- function(input, output, session) {
  ...
  # Observe event states the selected state to NULL whent the variable select input is change
  ...
  # Define a lookup table that maps input values to data sets and column names
  data_lookup <- list(
