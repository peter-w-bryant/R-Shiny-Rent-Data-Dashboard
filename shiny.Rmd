...
```{r}
compute_veighted_sum <- function(education_spending_weight, citizens_per_hospital_weight, median_home_prices_weight, median_listing_days_weight){
  ...
  tabPanel(
    ...
    fluidRow(
     ...
     fluidRow(
      ...
      column(width = 11, leafletOutput("us_county_map", height = "600px")),
      column(
        width = 1,
...
server <- function(input, output, session) {
  ...
  weighted_sum_data <- reactive({ compute_veighted_sum(input$education_spending_weight, input$citizens_per_hospital_weight, input$median_home_prices_weight, input$median_listing_days_weight)})
