      ...
      column(width = 4,
             div(
               style = "text-align: center;",
                 conditionalPanel(condition = "input.map_var == 'Median Days on the Market' && $('#selected_state_header').text() !== 'Please click on a state.'",                        plotOutput("median_days_plot", width = "100%", height = "1000px")
               ),
